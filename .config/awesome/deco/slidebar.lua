        ...
        if p == "top" or p == "left" then
            return function()
                ...
                if o.wslidebar[axis] < 0 then
                    o.wslidebar[axis] = o.wslidebar[axis] + delta_inc + 20 --This adds upper margin
                    return true
                end
                return false
            end
        ...
        if p == "top" or p == "left" then
            return function()
                ...
                if o.wslidebar[axis] > -size then
                    o.wslidebar[axis] = o.wslidebar[axis] - delta_inc - 20 --This counters the upper margin
                    return true
                else
                    return false
                end
...
local function calc_bar_geometry(o)
    local x = {
        ["top"] = 10, --This adds the left margin
        ["bottom"] = 0,
        ["left"] = -o.size,
    ...
    local width = {
        ["top"] = o.screen_width - 20, --This adds the right margin
